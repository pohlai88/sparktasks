...
describe('Workspace Rules Compliance', () => {
  ...
  describe('Documentation Quality', () => {
    ...
    it('should document all allowed top-level directories with purposes', () => {
      ...
      const expectedDirectories = [
        'docs', 'src', 'test', 'tools', '.github', '.vscode', 'node_modules', '.git'
      ];
  ...
  describe('Automation Tools', () => {
    it('should have enhanced workspace structure validator', () => {
      ...
      const validatorContent = readFileSync('tools/check-workspace-structure.js', 'utf-8');
    ...
    it('should have GitHub Actions workflow for enforcement', () => {
      ...
      const workflowContent = readFileSync('.github/workflows/workspace-lint.yml', 'utf-8');
  ...
  describe('SSOT Process Compliance', () => {
    ...
    it('should have comprehensive PR template with SSOT checklist', () => {
      ...
      const templateContent = readFileSync('.github/pull_request_template.md', 'utf-8');
      ...
      expect(templateContent).toContain('SHORT_PROMPT.md` updated if Section 1');
