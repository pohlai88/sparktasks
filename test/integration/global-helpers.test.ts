...
import { validateTask, validateTaskSerialized, validateTaskCreateInput } from '@shared/types';
...
describe('Global Test Helpers', () => {
  ...
  describe('Deterministic Clock Behavior', () => {
    ...
    it('should support date-sensitive business logic testing', () => {
      ...
      const isRecentTask = (task: ReturnType<typeof globalThis.testHelpers.createMockTask>) => {
