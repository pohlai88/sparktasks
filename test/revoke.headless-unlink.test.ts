...
import { revokeInvite, isInviteRevoked, revokeSigner, isSignerRevoked, setRevocationStorage } from '../src/revoke/registry';
...
async function mockVerify(_bytes: ArrayBuffer, sig: string, _pubB64u: string): Promise<boolean> {
