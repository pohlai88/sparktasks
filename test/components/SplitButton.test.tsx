...
describe('SplitButton Component - Enterprise Grade', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('applies proper default attributes', () => {
      ...
      const dropdownButton = screen.getByRole('button', { name: /show more options/i });
  ...
  describe('Placement Options', () => {
    it('supports different dropdown placements', async () => {
      ...
      const triggerButton = screen.getByRole('button', { name: /show more options/i });
      ...
      const newTriggerButton = screen.getByRole('button', { name: /show more options/i });
