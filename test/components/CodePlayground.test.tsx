...
describe('CodePlayground', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders with default props', () => {
      ...
      expect(
        screen.getByRole('region', { name: /interactive code playground/i })
      ).toBeInTheDocument();
    ...
    it('renders with custom aria-label', () => {
      ...
      expect(
        screen.getByRole('region', { name: 'Custom code editor' })
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Code Execution', () => {
    ...
    it('auto-runs code when autoRun is enabled', async () => {
      const onExecute = vi.fn();
      render(
        <CodePlayground autoRun onExecute={onExecute} autoRunDelay={100} />
      );
    ...
    it('respects autoRunDelay', async () => {
      const onExecute = vi.fn();
      render(
        <CodePlayground autoRun onExecute={onExecute} autoRunDelay={500} />
      );
  ...
  describe('Performance', () => {
    ...
    it('cancels previous auto-run when typing continues', async () => {
      const onExecute = vi.fn();
      render(
        <CodePlayground autoRun onExecute={onExecute} autoRunDelay={150} />
      );
