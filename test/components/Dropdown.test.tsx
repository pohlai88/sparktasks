...
describe('Dropdown Component - Enterprise Grade', () => {
  ...
  describe('Dropdown Functionality', () => {
    ...
    it('renders all dropdown items when open', async () => {
      ...
      expect(
        screen.getByRole('menuitem', { name: /download data/i })
      ).toBeInTheDocument();
      expect(
  ...
  describe('Link Handling', () => {
    it('handles internal links correctly', async () => {
      ...
      await user.click(screen.getByRole('button'));
      await user.click(
        screen.getByRole('menuitem', { name: /internal link/i })
      );
    ...
    it('handles external links correctly', async () => {
      ...
      await user.click(screen.getByRole('button'));
      await user.click(
        screen.getByRole('menuitem', { name: /external link/i })
      );
  ...
  describe('Advanced Features', () => {
    ...
    it('applies custom content className correctly', async () => {
      ...
      render(<Dropdown items={mockItems} contentClassName='custom-content' />);
