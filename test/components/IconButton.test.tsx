...
describe('IconButton Component - Enterprise Grade', () => {
  ...
  describe('Icon-Only Enforcement', () => {
    it('renders icon without text content', () => {
      render(<IconButton icon={<Settings data-testid="settings-icon" />} aria-label="Settings" />);
    ...
    it('requires aria-label for accessibility', () => {
      render(<IconButton icon={<Plus data-testid="plus-icon" />} aria-label="Add item" />);
  ...
  describe('Variant Rendering', () => {
    it('renders primary variant with correct styling', () => {
      render(<IconButton variant="primary" icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('renders secondary variant with correct styling', () => {
      render(<IconButton variant="secondary" icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('renders destructive variant with correct styling', () => {
      render(<IconButton variant="destructive" icon={<Trash2 />} aria-label="Delete" />);
    ...
    it('renders outline variant with correct styling', () => {
      render(<IconButton variant="outline" icon={<Edit />} aria-label="Edit" />);
  ...
  describe('Size Variations', () => {
    it('renders small size with correct classes', () => {
      render(<IconButton size="sm" icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('renders medium size (default) with correct classes', () => {
      render(<IconButton size="md" icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('renders large size with correct classes', () => {
      render(<IconButton size="lg" icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('renders extra large size with correct classes', () => {
      render(<IconButton size="xl" icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
  ...
  describe('Icon Integration', () => {
    ...
    it('scales icon size with button size', () => {
      render(<IconButton size="lg" icon={<Settings data-testid="settings-icon" />} aria-label="Settings" />);
  ...
  describe('State Management', () => {
    it('handles pending state correctly', () => {
      render(<IconButton pending icon={<Settings />} aria-label="Loading Settings" />);
    ...
    it('handles disabled state correctly', () => {
      render(<IconButton disabled icon={<Settings />} aria-label="Disabled Settings" />);
  ...
  describe('Event Handling', () => {
    it('handles click events correctly', async () => {
      ...
      render(<IconButton onClick={handleClick} icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('does not trigger click when disabled', async () => {
      ...
      render(<IconButton onClick={handleClick} disabled icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
    ...
    it('does not trigger click when pending', async () => {
      ...
      render(<IconButton onClick={handleClick} pending icon={<Settings />} aria-label="Settings" />);
      const button = screen.getByRole('button', { name: /settings/i });
  ...
  describe('Accessibility Compliance', () => {
    it('has proper focus management', async () => {
      ...
      render(<IconButton icon={<Settings />} aria-label="Focusable Settings" />);
      const button = screen.getByRole('button', { name: /focusable settings/i });
    ...
    it('supports keyboard navigation', async () => {
      ...
      render(<IconButton onClick={handleClick} icon={<Settings />} aria-label="Keyboard Settings" />);
  ...
  describe('Advanced Features', () => {
    it('applies custom className correctly', () => {
      render(<IconButton className="custom-class" icon={<Settings />} aria-label="Custom IconButton" />);
    ...
    it('forwards ref correctly', () => {
      ...
      render(<IconButton ref={ref} icon={<Settings />} aria-label="Ref IconButton" />);
  ...
  describe('Token Integration', () => {
    it('uses design tokens instead of hardcoded classes', () => {
      render(<IconButton variant="primary" icon={<Settings />} aria-label="Token IconButton" />);
    ...
    it('applies proper data attributes for debugging', () => {
      render(<IconButton variant="secondary" size="lg" icon={<Settings />} aria-label="Debug IconButton" />);
