...
describe('Note Component', () => {
  ...
  describe('Dismissible Functionality', () => {
    it('shows dismiss button when dismissible is true', () => {
      ...
      const dismissButton = screen.getByRole('button', { name: /dismiss note/i });
      expect(dismissButton).toBeInTheDocument();
    });

    it('hides dismiss button when dismissible is false', () => {
      render(
        <Note dismissible={false}>
          Non-dismissible content
        </Note>
      );
      
      const dismissButton = screen.queryByRole('button', { name: /dismiss note/i });
  ...
  describe('Collapsible Functionality', () => {
    it('shows collapse button when collapsible is true', () => {
      ...
      const collapseButton = screen.getByRole('button', { name: /collapse note/i });
      expect(collapseButton).toBeInTheDocument();
    });

    it('hides collapse button when collapsible is false', () => {
      render(
        <Note collapsible={false}>
          Non-collapsible content
        </Note>
      );
      
      const collapseButton = screen.queryByRole('button', { name: /collapse note/i });
  ...
  describe('Combined Features', () => {
    it('supports both dismissible and collapsible features', async () => {
      ...
      expect(screen.getByRole('button', { name: /dismiss note/i })).toBeInTheDocument();
