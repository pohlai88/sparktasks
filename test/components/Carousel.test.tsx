...
describe('Carousel Component - Enterprise Grade', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('applies custom aria labels', () => {
      ...
      expect(screen.getByRole('region')).toHaveAttribute('id', 'product-carousel');
    });
  });
  ...
  describe('Slide Navigation', () => {
    ...
    it('navigates to previous slide on arrow click', async () => {
      ...
      render(<Carousel items={defaultItems} onSlideChange={onSlideChange} startIndex={1} />);
    ...
    it('wraps around when infinite is enabled', async () => {
      ...
      render(<Carousel items={defaultItems} infinite onSlideChange={onSlideChange} startIndex={2} />);
  ...
  describe('Keyboard Navigation', () => {
    it('navigates with arrow keys when keyboard enabled', async () => {
      ...
      render(<Carousel items={defaultItems} enableKeyboard onSlideChange={onSlideChange} />);
    ...
    it('navigates to first/last slide with Home/End keys', async () => {
      ...
      render(<Carousel items={defaultItems} enableKeyboard onSlideChange={onSlideChange} startIndex={1} />);
    ...
    it('ignores keyboard when disabled', async () => {
      ...
      render(<Carousel items={defaultItems} enableKeyboard={false} onSlideChange={onSlideChange} />);
  ...
  describe('Auto-play Functionality', () => {
    ...
    it('toggles auto-play state', async () => {
      ...
      render(<Carousel items={defaultItems} autoPlay onAutoPlayToggle={onAutoPlayToggle} />);
      
      const toggleButton = screen.getByRole('button', { name: /pause slideshow/i });
  ...
  describe('Touch/Swipe Interaction', () => {
    ...
    it('ignores touch events when swipe disabled', () => {
      ...
      render(<Carousel items={defaultItems} swipeEnabled={false} onSlideChange={onSlideChange} />);
  ...
  describe('Thumbnail Navigation', () => {
    ...
    it('navigates to slide via thumbnail click', async () => {
      ...
      render(<Carousel items={defaultItems} showThumbnails onSlideChange={onSlideChange} />);
  ...
  describe('Custom Styling', () => {
    ...
    it('accepts custom containerClassName', () => {
      render(<Carousel items={defaultItems} containerClassName="custom-container" />);
  ...
  describe('Accessibility Features', () => {
    ...
    it('marks slides with proper ARIA attributes', () => {
      ...
      expect(screen.getByRole('button', { name: /carousel viewer/i })).toBeInTheDocument();
    });
