...
describe('Attachment Component', () => {
  ...
  describe('Size Variants', () => {
    ...
    it('renders detailed size correctly', () => {
      ...
      render(<Attachment title="Detailed Test" size="detailed" metadata={metadata} />);
      
      expect(screen.getByText('This is a detailed description of the attachment')).toBeInTheDocument();
      expect(screen.getByAltText('Preview of Detailed Test')).toBeInTheDocument();
    });
  });
  ...
  describe('Action Buttons', () => {
    it('shows preview button when showPreview is true', () => {
      ...
      render(<Attachment title="Preview Test" showPreview={true} onPreview={onPreview} />);
    ...
    it('hides preview button when showPreview is false', () => {
      ...
      expect(screen.queryByLabelText('Preview attachment')).not.toBeInTheDocument();
    });
    ...
    it('shows download button when showDownload is true', () => {
      ...
      render(<Attachment title="Download Test" showDownload={true} onDownload={onDownload} />);
    ...
    it('calls onDownload when download button is clicked', () => {
      const onDownload = vi.fn();
      render(<Attachment title="Download Click Test" onDownload={onDownload} />);
    ...
    it('shows remove button when showRemove is true', () => {
      ...
      render(<Attachment title="Remove Test" showRemove={true} onRemove={onRemove} />);
    ...
    it('calls onRemove when remove button is clicked', () => {
      const onRemove = vi.fn();
      render(<Attachment title="Remove Click Test" showRemove={true} onRemove={onRemove} />);
    ...
    it('prevents event propagation on action button clicks', () => {
      const onClick = vi.fn();
      const onPreview = vi.fn();
      render(<Attachment title="Propagation Test" onClick={onClick} onPreview={onPreview} />);
  ...
  describe('Special Indicators', () => {
    it('shows external link indicator when isExternal is true', () => {
      ...
      const externalIcon = screen.getByRole('article').querySelector('svg[class*="inline-block"]');
  ...
  describe('Upload Progress', () => {
    it('shows progress bar when status is uploading', () => {
      render(<Attachment title="Upload Progress Test" status="uploading" progress={50} />);
    ...
    it('updates progress bar width based on progress value', () => {
      render(<Attachment title="Progress Width Test" status="uploading" progress={75} />);
  ...
  describe('States and Interactions', () => {
    it('applies disabled state correctly', () => {
      const onClick = vi.fn();
      render(<Attachment title="Disabled Test" disabled={true} onClick={onClick} />);
    ...
    it('does not trigger actions when disabled', () => {
      const onPreview = vi.fn();
      render(<Attachment title="Disabled Actions Test" disabled={true} onPreview={onPreview} />);
    ...
    it('does not trigger actions when loading', () => {
      const onDownload = vi.fn();
      render(<Attachment title="Loading Actions Test" loading={true} onDownload={onDownload} />);
  ...
  describe('Accessibility', () => {
    ...
    it('hides decorative icons from screen readers', () => {
      ...
      const decorativeIcons = screen.getByRole('article').querySelectorAll('svg[aria-hidden="true"]');
  ...
  describe('Thumbnails and Media', () => {
    it('renders thumbnail in detailed view', () => {
      ...
      render(<Attachment title="Thumbnail Test" size="detailed" metadata={metadata} />);
      
      expect(screen.getByAltText('Preview of Thumbnail Test')).toBeInTheDocument();
    });

    it('does not render thumbnail in compact/default views', () => {
      const metadata = { thumbnailUrl: '/test-thumbnail.jpg' };
      
      render(<Attachment title="No Thumbnail Compact" size="compact" metadata={metadata} />);
      expect(screen.queryByAltText('Preview of No Thumbnail Compact')).not.toBeInTheDocument();
      
      render(<Attachment title="No Thumbnail Default" size="default" metadata={metadata} />);
      expect(screen.queryByAltText('Preview of No Thumbnail Default')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Custom Props and Styling', () => {
    ...
    it('applies custom style', () => {
      render(<Attachment title="Custom Style" style={{ backgroundColor: 'red' }} />);
    ...
    it('renders custom actions', () => {
      ...
      render(<Attachment title="Custom Actions" customActions={customAction} />);
