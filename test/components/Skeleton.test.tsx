...
describe('Skeleton Layout Components', () => {
  ...
  describe('SkeletonProfile', () => {
    ...
    it('supports custom avatar size', () => {
      render(<SkeletonProfile avatarSize="lg" data-testid="skeleton-profile" />);
    ...
    it('can hide bio when showBio=false', () => {
      render(<SkeletonProfile showBio={false} data-testid="skeleton-profile" />);
  ...
  describe('SkeletonList', () => {
    ...
    it('supports different item types', () => {
      render(<SkeletonList itemType="profile" count={2} data-testid="skeleton-list" />);
    ...
    it('supports card item type', () => {
      render(<SkeletonList itemType="card" count={2} data-testid="skeleton-list" />);
    ...
    it('supports horizontal layout', () => {
      render(<SkeletonList direction="horizontal" data-testid="skeleton-list" />);
