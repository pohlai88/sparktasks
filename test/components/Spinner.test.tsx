...
describe('Spinner Component - Enterprise Grade', () => {
  ...
  describe('SVG Structure and Animation', () => {
    ...
    it('includes animateTransform element for SVG animation', () => {
      ...
      const animateElements = spinner.querySelectorAll('animatetransform, animateTransform');
...
describe('PageSpinner Component', () => {
  ...
  it('includes backdrop by default', () => {
    ...
    expect(overlay).toHaveClass('bg-white/80', 'dark:bg-gray-900/80', 'backdrop-blur-sm');
  });
  ...
  it('renders with custom label', () => {
    ...
    const pageWrapper = document.querySelector('[aria-label="Loading application..."]');
