...
describe('CodeBlock', () => {
  ...
  describe('Language Support', () => {
    it('displays language in screen reader text', () => {
      ...
      expect(screen.getByText(/Code language: TypeScript React/)).toBeInTheDocument();
    });
    ...
    it('handles common languages correctly', () => {
      ...
      testCases.forEach(({ code, label }) => {
        ...
        expect(screen.getByText(new RegExp(`Code language: ${label}`))).toBeInTheDocument();
        unmount();
      });
    });
  });
  ...
  describe('Line Numbers', () => {
    ...
    it('highlights specific lines when highlightLines is provided', () => {
      const multiLineCode = 'line 1\nline 2\nline 3';
      render(<CodeBlock showLineNumbers highlightLines={[2]}>{multiLineCode}</CodeBlock>);
  ...
  describe('Accessibility', () => {
    ...
    it('supports keyboard navigation for interactive elements', () => {
      render(<CodeBlock copyable collapsible>const test = true;</CodeBlock>);
