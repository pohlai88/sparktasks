...
describe('List Component - Basic Rendering', () => {
  ...
  it('passes through HTML attributes', () => {
    render(
      <List data-testid='list-element' aria-label='Test list'>
        Content
      </List>
    );
...
describe('ListItem Component - Layout and Spacing', () => {
  ...
  it('applies layout variants correctly', () => {
    const { rerender } = render(
      <ListItem layout='singleLine'>Content</ListItem>
    );
...
describe('List Component - Keyboard Navigation', () => {
  ...
  it('ignores keyboard events when disabled', async () => {
    ...
    render(
      <ListItem disabled onSelect={handleSelect}>
        Disabled item
      </ListItem>
    );
...
describe('ListItem.Content Component', () => {
  ...
  it('renders meta information correctly', () => {
    ...
    expect(screen.getByText('Test Meta')).toHaveClass(
      'text-xs',
      'text-slate-500'
    );
  });
...
describe('ListItem.Icon Component', () => {
  ...
  it('applies variant classes correctly', () => {
    const { rerender } = render(
      <ListItemIcon variant='primary'>{createTestIcon()}</ListItemIcon>
    );
...
describe('ListItem.Action Component', () => {
  ...
  it('applies correct positioning classes', () => {
    render(
      <ListItemAction data-testid='action-wrapper'>
        {createTestAction()}
      </ListItemAction>
    );
    expect(screen.getByTestId('action-wrapper')).toHaveClass(
      'flex-shrink-0',
      'ml-auto'
    );
  });
...
describe('List Component - Context Integration', () => {
  ...
  it('allows item-level overrides of context', () => {
    render(
      <List interactive>
        <ListItem interactive={false} data-testid='non-interactive'>
...
describe('List Component - Edge Cases', () => {
  ...
  it('maintains focus after state changes', async () => {
    const { rerender } = render(
      <List>
        <ListItem interactive data-testid='focus-item'>
          Focusable item
        </ListItem>
      </List>
    );
