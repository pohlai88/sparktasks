...
describe('EnhancedBadge', () => {
  ...
  describe('Variant System', () => {
    const semanticVariants = ['default', 'secondary', 'muted', 'accent'] as const;
  ...
  describe('Count Display', () => {
    it('displays count when provided', () => {
      render(
        <EnhancedBadge count={5} data-testid="badge" />
      );
    ...
    it('displays overflow indicator when count exceeds max', () => {
      render(
        <EnhancedBadge count={150} max={99} data-testid="badge" />
      );
    ...
    it('displays exact count when showOverflow is false', () => {
      render(
        <EnhancedBadge count={150} max={99} showOverflow={false} data-testid="badge" />
      );
    ...
    it('displays children when count is not provided', () => {
      render(
        <EnhancedBadge data-testid="badge">Custom Text</EnhancedBadge>
      );
  ...
  describe('Icon Support', () => {
    ...
    it('displays icon in right position when specified', () => {
      render(
        <EnhancedBadge icon={<TestIcon />} iconPosition="right" data-testid="badge">
          Content
        </EnhancedBadge>
      );
...
describe('BadgeFactory', () => {
  describe('Semantic Variants', () => {
    const semanticFactories = ['default', 'secondary', 'muted', 'accent'] as const;
    ...
    semanticFactories.forEach((factory) => {
      it(`provides ${factory} factory`, () => {
        ...
        render(
          <Badge data-testid={`${factory}-badge`}>
            {factory} content
          </Badge>
        );
  ...
  describe('Feature Variants', () => {
    it('provides interactive factory', () => {
      ...
      render(
        <Badge data-testid="interactive-badge">
          Interactive content
        </Badge>
      );
    ...
    it('provides dismissible factory', () => {
      ...
      render(
        <Badge data-testid="dismissible-badge">
          Dismissible content
        </Badge>
      );
...
describe('Utility Functions', () => {
  describe('createCountBadge', () => {
    ...
    it('accepts additional props', () => {
      ...
      const badgeElement = screen.getByTestId('count-badge').firstElementChild as HTMLElement;
  ...
  describe('createStatusDot', () => {
    it('creates a status dot with correct variant', () => {
      ...
      const badgeElement = screen.getByTestId('status-dot').firstElementChild as HTMLElement;
      expect(badgeElement).toHaveAttribute('data-variant', 'success');
    ...
    it('works with different status variants', () => {
      ...
      variants.forEach((variant) => {
        ...
        render(<div key={variant} data-testid={`${variant}-dot`}>{badge}</div>);
        
        const badgeElement = screen.getByTestId(`${variant}-dot`).firstElementChild as HTMLElement;
  ...
  describe('createNotificationBadge', () => {
    it('creates a count badge when count is provided', () => {
      ...
      const badgeElement = screen.getByTestId('notification-badge').firstElementChild as HTMLElement;
    ...
    it('creates a dot badge when count is zero', () => {
      ...
      const badgeElement = screen.getByTestId('notification-dot').firstElementChild as HTMLElement;
      expect(badgeElement).toHaveAttribute('data-variant', 'error');
      expect(badgeElement).toHaveAttribute('data-size', 'sm');
      expect(badgeElement).toHaveAttribute('data-dot', 'true');
    });
