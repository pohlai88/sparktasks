...
describe('EnhancedDatePicker', () => {
  describe('Basic Rendering', () => {
    ...
    it('applies custom className', () => {
      render(<EnhancedDatePicker className="custom-class" data-testid="datepicker-container" />);
  ...
  describe('Variant Styling', () => {
    it('applies default surface variant', () => {
      render(<EnhancedDatePicker surface="default" data-testid="datepicker-container" />);
    ...
    it('applies glass surface variant', () => {
      render(<EnhancedDatePicker surface="glass" data-testid="datepicker-container" />);
    ...
    it('applies different sizes', () => {
      const { rerender } = render(<EnhancedDatePicker size="sm" data-testid="datepicker-container" />);
      ...
      rerender(<EnhancedDatePicker size="lg" data-testid="datepicker-container" />);
    ...
    it('applies validation states', () => {
      const { rerender } = render(<EnhancedDatePicker validation="error" data-testid="datepicker-container" />);
      ...
      rerender(<EnhancedDatePicker validation="success" data-testid="datepicker-container" />);
      container = screen.getByTestId('datepicker-container');
