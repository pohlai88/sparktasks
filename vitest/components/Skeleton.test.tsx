...
describe('EnhancedSkeleton - Size Variants', () => {
  it('should generate correct text size variants', () => {
    expect(enhancedSkeletonVariants({ variant: 'text', size: 'sm' })).toContain(
      'h-3'
    );
    expect(enhancedSkeletonVariants({ variant: 'text', size: 'md' })).toContain(
      'h-4'
    );
    expect(enhancedSkeletonVariants({ variant: 'text', size: 'lg' })).toContain(
      'h-5'
    );
    expect(enhancedSkeletonVariants({ variant: 'text', size: 'xl' })).toContain(
      'h-6'
    );
  });
  ...
  it('should generate correct avatar size variants', () => {
    expect(
      enhancedSkeletonVariants({ variant: 'avatar', size: 'sm' })
    ).toContain('h-8 w-8');
    expect(
      enhancedSkeletonVariants({ variant: 'avatar', size: 'md' })
    ).toContain('h-10 w-10');
    expect(
      enhancedSkeletonVariants({ variant: 'avatar', size: 'lg' })
    ).toContain('h-12 w-12');
    expect(
      enhancedSkeletonVariants({ variant: 'avatar', size: 'xl' })
    ).toContain('h-16 w-16');
  });

  it('should generate correct button size variants', () => {
    expect(
      enhancedSkeletonVariants({ variant: 'button', size: 'sm' })
    ).toContain('h-8');
    expect(
      enhancedSkeletonVariants({ variant: 'button', size: 'md' })
    ).toContain('h-10');
    expect(
      enhancedSkeletonVariants({ variant: 'button', size: 'lg' })
    ).toContain('h-12');
    expect(
  ...
  it('should generate correct card size variants', () => {
    expect(enhancedSkeletonVariants({ variant: 'card', size: 'sm' })).toContain(
      'h-32'
    );
    expect(enhancedSkeletonVariants({ variant: 'card', size: 'md' })).toContain(
      'h-48'
    );
    expect(enhancedSkeletonVariants({ variant: 'card', size: 'lg' })).toContain(
      'h-64'
    );
    expect(enhancedSkeletonVariants({ variant: 'card', size: 'xl' })).toContain(
      'h-80'
    );
  });
  ...
  it('should generate correct badge size variants', () => {
    expect(
      enhancedSkeletonVariants({ variant: 'badge', size: 'sm' })
    ).toContain('h-4 w-12');
    expect(
      enhancedSkeletonVariants({ variant: 'badge', size: 'md' })
    ).toContain('h-5 w-16');
    expect(
      enhancedSkeletonVariants({ variant: 'badge', size: 'lg' })
    ).toContain('h-6 w-20');
  });
...
describe('EnhancedSkeleton - AAA Compliance', () => {
  ...
  it('should generate correct AAA surface combinations', () => {
    const elevatedAAA = enhancedSkeletonVariants({
      surface: 'elevated',
      enforceAAA: true,
    });
    expect(elevatedAAA).toContain('aaa:bg-background-elevated-aaa');

    const glassAAA = enhancedSkeletonVariants({
      surface: 'glass',
      enforceAAA: true,
    });
...
describe('EnhancedSkeleton - Component Rendering', () => {
  ...
  it('should render with custom className', () => {
    render(
      <EnhancedSkeleton className='custom-class' data-testid='skeleton' />
    );
    const skeleton = screen.getByTestId('skeleton');
  ...
  it('should render with custom width and height', () => {
    render(
      <EnhancedSkeleton width='200px' height='100px' data-testid='skeleton' />
    );
    const skeleton = screen.getByTestId('skeleton');
  ...
  it('should render with numeric width and height', () => {
    render(
      <EnhancedSkeleton width={300} height={150} data-testid='skeleton' />
    );
    const skeleton = screen.getByTestId('skeleton');
...
describe('EnhancedSkeleton - Variant Rendering', () => {
  ...
  it('should render avatar variant correctly', () => {
    render(
      <EnhancedSkeleton variant='avatar' size='md' data-testid='skeleton' />
    );
    const skeleton = screen.getByTestId('skeleton');
  ...
  it('should render card variant correctly', () => {
    render(
      <EnhancedSkeleton variant='card' size='lg' data-testid='skeleton' />
    );
    const skeleton = screen.getByTestId('skeleton');
  ...
  it('should render badge variant correctly', () => {
    render(
      <EnhancedSkeleton variant='badge' size='sm' data-testid='skeleton' />
    );
    const skeleton = screen.getByTestId('skeleton');
