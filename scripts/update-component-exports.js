...
function updateComponentExports(componentDir) {
...
// Main execution
const componentsDir = resolve(__dirname, '../src/design/audits/components');
updateComponentExports(componentsDir);

// You can add more directories here if needed
// updateComponentExports(resolve(__dirname, '../src/components/ui'));
