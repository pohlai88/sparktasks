...
const userData: UserData[] = [
  { id: 1, name: 'Sarah Chen', email: 'sarah.chen@company.com', status: 'active', role: 'Design Lead', joinDate: '2023-01-15', lastActive: '2 minutes ago' },
  { id: 2, name: 'Marcus Rodriguez', email: 'marcus.r@company.com', status: 'active', role: 'Product Manager', joinDate: '2023-02-20', lastActive: '1 hour ago' },
  { id: 3, name: 'Emma Thompson', email: 'emma.thompson@company.com', status: 'inactive', role: 'Developer', joinDate: '2023-03-10', lastActive: '3 days ago' },
  { id: 4, name: 'David Park', email: 'david.park@company.com', status: 'active', role: 'Data Analyst', joinDate: '2023-04-05', lastActive: '30 minutes ago' },
  { id: 5, name: 'Zara Ahmed', email: 'zara.ahmed@company.com', status: 'pending', role: 'UX Researcher', joinDate: '2023-05-12', lastActive: 'Never' },
]
...
export function DataDemo() {
  ...
  const StatusBadge = ({ status }: { status: UserData['status'] }) => {
    ...
    return (
      <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border ${colors.background} ${colors.border}`}>
    ...
    },
    {
      ...
      cell: ({ row }: { row: { original: UserData } }) => (
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Active {row.original.lastActive}</p>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }: { row: { original: SalesData } }) => (
        <div className="flex items-center gap-2">
          ...
          <span className="text-foreground">{row.original.customers.toLocaleString()}</span>
        </div>
      ),
    },
    {
      ...
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
            Professional data components following Apple HIG philosophy - sophisticated,
            user-respectful design with the 80/20 strategy for comprehensive data applications.
          </p>
        </div>
            ...
            <EnhancedCard className="border-border">
              <EnhancedCardHeader>
                ...
                <EnhancedCardDescription>
                  Revenue trends over 6 months with sophisticated data visualization
                </EnhancedCardDescription>
              </EnhancedCardHeader>
              <EnhancedCardContent>
                <BarChart
        ...
        <section className="space-y-6">
          ...
          <EnhancedCard className="border-border">
            <EnhancedCardHeader>
              ...
              <EnhancedCardDescription>
                Interactive user data table with sophisticated selection and filtering
              </EnhancedCardDescription>
            </EnhancedCardHeader>
            <EnhancedCardContent>
              <SimpleTable
              ...
              {selectedUser && (
                <div className="mt-4 p-4 rounded-lg border border-border bg-muted/50">
                  <h4 className="font-medium text-foreground">Selected Team Member</h4>
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-foreground">Enhanced Forms</h2>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <EnhancedCard className="border-border">
              <EnhancedCardHeader>
                ...
                <EnhancedCardDescription>
                  Professional contact form with validation and Apple HIG styling
                </EnhancedCardDescription>
              </EnhancedCardHeader>
              <EnhancedCardContent>
                <EnhancedForm
            ...
            <EnhancedCardContent className="p-6">
              <div className="prose prose-sm max-w-none">
                <p className="text-muted-foreground mb-4">
                  This showcase demonstrates the <strong className="text-foreground">80/20 Strategy</strong> in action:
                  our 3 data-enhanced components cover 80% of typical data visualization and form requirements
                  with sophisticated Apple HIG color philosophy and user-respectful design.
                </p>

                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-3">Components Demonstrated</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-blue-500" />
                        <span className="text-foreground"><strong>SimpleTable</strong> - Universal data table with sorting, pagination, selection</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-emerald-500" />
                        <span className="text-foreground"><strong>EnhancedForm</strong> - Schema-driven forms with validation and elegant layouts</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-purple-500" />
                        <span className="text-foreground"><strong>BarChart & LineChart</strong> - Professional visualization with Nivo integration</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-3">Technical Excellence</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-amber-500" />
                        <span className="text-foreground">MAPS v3.0 design system integration</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-blue-500" />
                        <span className="text-foreground">Apple HIG sophisticated color philosophy</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-emerald-500" />
                        <span className="text-foreground">TypeScript with comprehensive type safety</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-purple-500" />
                        <span className="text-foreground">WCAG AAA accessibility compliance</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="h-2 w-2 rounded-full bg-rose-500" />
                        <span className="text-foreground">Liquid glass materials and dark mode excellence</span>
                      </li>
                    </ul>
                  </div>
                </div>
