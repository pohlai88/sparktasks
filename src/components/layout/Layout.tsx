...
export function Drawer({ isOpen, onClose, children, title }: DrawerProps) {
  ...
  return (
    <div className='fixed inset-0 z-50 lg:hidden'>
      ...
      <div className={DESIGN_TOKENS.layout.patterns.drawerPanel}>
        <div className={DESIGN_TOKENS.layout.patterns.cardHeader}>
          {title && (
            <h3 className={`${DESIGN_TOKENS.typography.body.primary}`}>
              {title}
            </h3>
          )}
          <button
        ...
        <div
          className={`${DESIGN_TOKENS.layout.patterns.panelSection} overflow-y-auto`}
        >
          {children}
        </div>
      </div>
