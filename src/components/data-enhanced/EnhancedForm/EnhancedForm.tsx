...
import { useForm, type FieldValues, type FieldError, type UseFormRegister, type Path } from 'react-hook-form'
...
const fieldGroupVariants = cva([
  ...
  variants: {
    layout: {
      vertical: 'space-y-2',
      horizontal: 'grid grid-cols-12 gap-4 items-start',
...
const labelVariants = cva([
  ...
  variants: {
    layout: {
      vertical: ENHANCED_DESIGN_TOKENS.foundation.typography.subhead,
      horizontal: [
        'col-span-3 pt-2',
        ENHANCED_DESIGN_TOKENS.foundation.typography.footnote,
      ],
      inline: ENHANCED_DESIGN_TOKENS.foundation.typography.footnote,
    },
    required: {
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <label
          htmlFor={String(field.name)}
          className={labelVariants({ layout: 'vertical', required: field.required })}
        >
          {field.label}
        </label>
      </div>
