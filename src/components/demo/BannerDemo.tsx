...
export default function BannerDemo() {
  ...
  const maintenanceActions: BannerAction[] = [
    { label: 'More Info', onClick: handleMaintenanceAction, variant: 'primary' },
    { label: 'System Status', href: '/status', variant: 'secondary', external: true }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Main Content */}
      <div className={`mx-auto max-w-6xl space-y-8 px-4 py-8 ${showTopBanner ? 'pt-24' : ''}`}>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <BannerSuccess
              ...
              actions={[
                { label: 'View Details', onClick: () => addNotification('Success details viewed'), variant: 'primary' }
              ]}
              dismissible
            />
            ...
            <BannerWarning
              ...
              actions={[
                { label: 'Review Settings', onClick: () => addNotification('Settings reviewed'), variant: 'primary' },
                { label: 'Remind Later', onClick: () => addNotification('Reminder set'), variant: 'secondary' }
              ]}
              dismissible
            />
            ...
            <BannerError
              ...
              actions={[
                { label: 'Try Again', onClick: () => addNotification('Retrying operation'), variant: 'primary' },
            ...
            <BannerAnnouncement
              ...
              actions={[
                { label: 'Explore Features', onClick: () => addNotification('Features explored'), variant: 'primary' },
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <BannerWarning
              ...
              actions={[
                { label: 'Take Action', onClick: () => addNotification('Action taken'), variant: 'primary' }
              ]}
              dismissible
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border bg-white p-6 dark:bg-gray-800">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Top banner example is shown at the top of this page (if not dismissed).
                Bottom banners work similarly but stick to the bottom of the viewport.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-lg border bg-white p-6 dark:bg-gray-800">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              ...
              <li>• Keyboard navigation support (Tab through actions, Enter to activate)</li>
