    ...
    <div className='mx-auto max-w-4xl space-y-8 p-8'>
      <div className='text-center'>
        ...
        <p className='mb-6 text-slate-600 dark:text-slate-400'>
          Enterprise-grade inline notifications with semantic variants and
          accessibility
        </p>
        <button
          onClick={resetDemos}
      ...
      <section>
        ...
        <div className='space-y-4'>
          <Alert variant='info' title='Information Alert'>
            This is an informational message to keep users informed about system
            status.
          </Alert>
          ...
          <Alert variant='warning' title='Warning Alert'>
            Please review this information carefully before proceeding with the
            action.
          </Alert>
      ...
      <section>
        ...
        <div className='space-y-4'>
          <Alert variant='error' title='Action Required'>
            ...
            <AlertAction
              variant='primary'
              onClick={() => alert('Extend session clicked!')}
            >
              Extend Session
            </AlertAction>
            <AlertAction
              variant='secondary'
              onClick={() => alert('Save now clicked!')}
            >
              Save Now
            </AlertAction>
          </Alert>
      ...
      <section>
        ...
        >
          <div className='space-y-2'>
            <p>
              Scheduled maintenance will occur on Sunday, March 15th from 2:00
              AM to 6:00 AM EST. During this time, some features may be
              unavailable.
            </p>
          ...
          <AlertAction
            variant='primary'
            onClick={() => alert('Schedule reminder!')}
          >
            Set Reminder
          </AlertAction>
      ...
      <section>
        ...
        <div className='space-y-4'>
          <Alert variant='info' title='Screen Reader Friendly'>
            This alert includes ARIA labels and live regions for screen reader
            accessibility.
          </Alert>

          <Alert variant='success' title='Keyboard Navigation'>
            All interactive elements support keyboard navigation and focus
            management.
          </Alert>
