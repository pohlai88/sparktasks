    ...
    >
      ...
      <div className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <p className={DESIGN_TOKENS.typography.body.secondary}>
          Enterprise-grade highlighted information blocks with comprehensive
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className='space-y-4'>
          <Callout variant='info' title='Information'>
            This is an informational callout used to provide helpful context or
            additional details.
          </Callout>

          <Callout variant='success' title='Success'>
            Operation completed successfully! Your changes have been saved and
            are now active.
          </Callout>

          <Callout variant='warning' title='Warning'>
            Please review the following items before proceeding. Some
            configurations may need attention.
          </Callout>
          ...
          <Callout variant='note' title='Note'>
            This is a general note callout for neutral information that doesn't
            fit other semantic categories.
          </Callout>
        </div>
      </section>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className='space-y-4'>
          <Callout variant='info' size='sm' title='Small Size'>
            Compact callout perfect for inline notices or space-constrained
            layouts.
          </Callout>

          <Callout variant='success' size='md' title='Medium Size (Default)'>
            Standard callout size that works well for most use cases and content
            lengths.
          </Callout>

          <Callout variant='warning' size='lg' title='Large Size'>
            Spacious callout ideal for important announcements or detailed
            explanations that need more visual prominence.
          </Callout>
        </div>
      </section>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className='space-y-4'>
          ...
          {customIconDemo && (
            ...
            >
              Callout with a custom lightning bolt icon instead of the default
              warning icon.
            </Callout>
          )}
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className='space-y-4'>
          {showDismissible && (
            ...
            >
              This callout can be dismissed by clicking the × button. Perfect
              for temporary notifications or announcements.
            </Callout>
          )}
        ...
        <div className='space-y-4'>
          <Callout variant='info' title='Multiple Paragraphs'>
            <p className={DESIGN_TOKENS.spacing.workspace.paragraphMargin}>
              Callouts support rich content including multiple paragraphs,
              lists, and other elements.
            </p>
            <p className={DESIGN_TOKENS.spacing.workspace.paragraphMargin}>
              This flexibility makes them perfect for complex announcements or
        ...
        <div className='space-y-4'>
          <Callout variant='info' title='WCAG 2.1 AA Compliance'>
            <ul className='list-inside list-disc space-y-2'>
              <li>
                <strong>Semantic ARIA roles:</strong> Error/warning use 'alert',
                success uses 'status', info/note use 'note'
              </li>
              <li>
                <strong>Live regions:</strong> Error/warning are 'assertive',
                others are 'polite'
              </li>
              <li>
                <strong>Keyboard navigation:</strong> Dismiss button is fully
                keyboard accessible
              </li>
              <li>
                <strong>Screen reader support:</strong> Icons are properly
