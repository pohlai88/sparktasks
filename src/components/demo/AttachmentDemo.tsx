...
const AttachmentDemo: React.FC = () => {
  ...
  const [selectedStatus, setSelectedStatus] =
    useState<AttachmentStatus>('complete');
  ...
  const sampleAttachments = [
    {
      ...
      metadata: {
        ...
        uploadedBy: 'John Doe',
        description:
          'Comprehensive financial analysis for Q4 2024 including revenue, expenses, and projections.',
        downloadCount: 42,
        isSecure: true,
      },
    },
  ...
  return (
    <div className={DESIGN_TOKENS.layout.container}>
      ...
      <div className={DESIGN_TOKENS.spacing.workspace.titleMargin}>
        ...
        >
          Enterprise-grade attachment component with comprehensive file
          management features.
        </p>
      </div>
      ...
      <div
        className={combineTokens(
          'mb-8 rounded-lg bg-gray-50 p-6',
      ...
      >
        ...
        <div
          className={`${DESIGN_TOKENS.breakpoints.responsiveGrid} ${DESIGN_TOKENS.spacing.xl}`}
        >
          {/* Size Control */}
          <div>
            <label
          ...
          <div>
            ...
            <select
              ...
              onChange={e =>
                setSelectedStatus(e.target.value as AttachmentStatus)
              }
              className={combineTokens(
                'w-full rounded-md border border-gray-300 px-3 py-2',
                DESIGN_TOKENS.theme.light.radius.md
          ...
          <div>
            ...
            <div
              className={`${DESIGN_TOKENS.layout.flexCenter} ${DESIGN_TOKENS.spacing.sm}`}
            >
              <input
                id='progress-control'
                type='range'
      ...
      <div className={DESIGN_TOKENS.spacing.workspace.titleMargin}>
        ...
        <Attachment
          ...
          metadata={{
            ...
            description:
              'This attachment demonstrates all interactive features and can be customized using the controls above.',
            isSecure: true,
            downloadCount: 15,
          }}
      ...
      <div className={DESIGN_TOKENS.spacing.workspace.titleMargin}>
        ...
        <div className={`grid ${DESIGN_TOKENS.spacing.xl}`}>
          {(['compact', 'default', 'detailed'] as AttachmentSize[]).map(
            size => (
              <div key={size}>
                <h3
                  className={combineTokens(
