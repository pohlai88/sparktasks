    ...
    <div className='mx-auto max-w-4xl space-y-12 p-8'>
      <div className='space-y-4 text-center'>
        ...
        <p className='text-lg text-slate-600 dark:text-slate-300'>
          Enterprise-grade keyboard key display with multiple variants and
        ...
        <div className='space-y-4'>
          <div className='flex items-center gap-6'>
            ...
            <span className='text-sm text-slate-600 dark:text-slate-400'>
              Standard key appearance with depth
            </span>
          </div>
          <div className='flex items-center gap-6'>
            <span className='w-20 text-sm font-medium text-slate-700 dark:text-slate-300'>
            ...
            <span className='text-sm text-slate-600 dark:text-slate-400'>
              Key combinations with separators
            </span>
          </div>
          <div className='flex items-center gap-6'>
            <span className='w-20 text-sm font-medium text-slate-700 dark:text-slate-300'>
      ...
      <section className='space-y-6'>
        ...
        <div className='space-y-4'>
          <div>
            <h3 className='mb-3 text-lg font-medium text-slate-700 dark:text-slate-300'>
              Arrow Keys
            </h3>
      ...
      <section className='space-y-6'>
        ...
        <div className='space-y-4 rounded-lg bg-slate-50 p-6 dark:bg-slate-800'>
          <div className='space-y-2'>
            <h4 className='font-medium text-slate-700 dark:text-slate-300'>
              Basic Key
            </h4>
            <code className='block rounded bg-white p-2 text-sm text-slate-600 dark:bg-slate-900 dark:text-slate-400'>
              {`<KBD>Enter</KBD>`}
            </code>
          </div>
          <div className='space-y-2'>
