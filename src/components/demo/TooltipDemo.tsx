...
export const TooltipDemo: React.FC = () => {
  ...
  const complexContent = (
    <div style={{ maxWidth: '300px' }}>
      <h4 style={{ margin: '0 0 8px 0', fontWeight: 'bold' }}>Rich Tooltip Content</h4>
      <p style={{ margin: '0 0 8px 0', fontSize: '14px' }}>
        This tooltip can contain complex React content including:
      </p>
      <ul style={{ margin: '0', paddingLeft: '16px', fontSize: '14px' }}>
        <li>Formatted text with <strong>bold</strong> and <em>italic</em></li>
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        <h3>Focus Trigger</h3>
        <Tooltip content="Accessible tooltip shown on focus for keyboard users" trigger="focus">
          <input 
            type="text"
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <Tooltip content="Tooltip positioned below the trigger" position="bottom">
          <button 
            style={{ 
              padding: '12px 24px',
