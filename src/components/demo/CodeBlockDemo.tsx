...
+       <Button variant="primary" size="lg">
  ...
  return (
    <div className={combineTokens('mx-auto max-w-6xl p-8', 'space-y-12')}>
      {/* Header */}
      <div className='space-y-4 text-center'>
        ...
        <p
          className={combineTokens(
            ...
            'mx-auto max-w-3xl text-slate-600 dark:text-slate-400'
          )}
        >
          Enterprise-grade code syntax display with copy functionality, line
          numbers, collapsible sections, multiple variants, and full
          accessibility support.
        </p>
      </div>

      {/* Tab Navigation */}
      <div className='flex justify-center space-x-1 rounded-lg bg-slate-100 p-1 dark:bg-slate-800'>
        <TabButton
            ...
            <div className='space-y-6'>
              ...
              >
                ...
                <ul className='space-y-2 text-sm text-slate-600 dark:text-slate-400'>
                  <li>
                    •{' '}
                    <kbd className='rounded bg-slate-200 px-2 py-1 text-xs dark:bg-slate-700'>
                      Tab
                    </kbd>{' '}
                  ...
                  <li>
                    ...
                    - Activate copy/collapse buttons
                  </li>
                  <li>
                    • Screen readers announce code language, line count, and
                    available actions
                  </li>
                  <li>
...
>
  {codeContent}
      ...
      <section
        className={combineTokens(
          'rounded-lg bg-slate-50 p-6 dark:bg-slate-800',
          'border border-slate-200 dark:border-slate-700'
        )}
      >
        <h2
          className={combineTokens(DESIGN_TOKENS.typography.heading.h3, 'mb-4')}
        >
          Usage Examples
        </h2>
        <div className='space-y-4'>
...
function InteractiveCodeBlockDemo() {
  ...
  return (
    <div className='space-y-6'>
      ...
      <div
        className={combineTokens(
          'grid grid-cols-2 gap-4 p-4 md:grid-cols-4',
      ...
      >
        <div>
          ...
          <select
            ...
            onChange={e =>
              setConfig({ ...config, variant: e.target.value as any })
            }
        ...
        <div className='space-y-2'>
          <label className='flex items-center space-x-2'>
            <input
              ...
              onChange={e =>
                setConfig({ ...config, showLineNumbers: e.target.checked })
              }
              className='rounded'
            />
          ...
          <label className='flex items-center space-x-2'>
            <input
              ...
              onChange={e =>
                setConfig({ ...config, copyable: e.target.checked })
              }
              className='rounded'
            />
          ...
          <label className='flex items-center space-x-2'>
            <input
              ...
              onChange={e =>
                setConfig({ ...config, collapsible: e.target.checked })
              }
              className='rounded'
            />
