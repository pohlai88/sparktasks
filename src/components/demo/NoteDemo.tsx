    ...
    <div className={combineTokens(
      ...
      <div className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <p className={DESIGN_TOKENS.typography.body.secondary}>
          Enterprise-grade informational notes for neutral content with advanced features and accessibility.
        </p>
      </div>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className="space-y-4">
          <Note variant="default" title="Default Note">
            This is the default note style with subtle background and border, perfect for general information and tips.
          </Note>
          
          <Note variant="subtle" title="Subtle Note">
            A more understated appearance with lighter background, ideal for secondary information that shouldn&apos;t compete with primary content.
          </Note>
          
          <Note variant="outlined" title="Outlined Note">
            Clean outlined style with transparent background, great for minimal designs and when you need clear visual separation.
          </Note>
          
          <Note variant="filled" title="Filled Note">
            Solid background variant that provides stronger visual emphasis for important but non-critical information.
          </Note>
        </div>
      </section>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className="space-y-4">
          ...
          <Note variant="default" size="md" title="Medium Note (Default)">
            Standard size that works well for most use cases and content lengths.
          </Note>
          
          <Note variant="filled" size="lg" title="Large Note">
            Spacious note ideal for detailed explanations or important announcements that need visual prominence.
          </Note>
        </div>
      </section>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className="space-y-4">
          ...
          <Note icon="bookmark" title="Reference Icon">
            Bookmark icon ideal for references, documentation links, and important resources.
          </Note>
          
          <Note icon="note" title="Note Icon">
            Classic note icon for traditional note-taking and documentation contexts.
          </Note>
          
          <Note icon={customIcon} title="Custom Icon">
            Custom icons can be provided for specialized use cases and brand-specific implementations.
          </Note>
          
          <Note showIcon={false} title="No Icon">
            Notes can also be displayed without icons for minimal design approaches.
          </Note>
        </div>
      </section>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className="space-y-4">
          ...
          {showDismissible && (
            ...
            >
              This note can be dismissed by clicking the × button. Perfect for temporary tips or one-time announcements.
            </Note>
          )}
          ...
          {showCollapsible && (
            ...
            >
              <p className={DESIGN_TOKENS.spacing.workspace.paragraphMargin}>
                This note can be collapsed to save space while keeping the title visible.
              </p>
              <p className={DESIGN_TOKENS.spacing.workspace.paragraphMargin}>
                Perfect for detailed explanations that users can expand when needed.
              </p>
          ...
          {showCombined && (
            ...
            >
              ...
              <ul className="list-inside list-disc space-y-1">
                <li><strong>Collapsible:</strong> Starts collapsed, can be expanded</li>
                <li><strong>Dismissible:</strong> Can be permanently removed</li>
                <li><strong>Accessible:</strong> Full keyboard navigation support</li>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <div className="space-y-4">
          <Note variant="default" title="Structured Content" collapsible>
            <p className={DESIGN_TOKENS.spacing.workspace.paragraphMargin}>
              Notes support rich content including multiple paragraphs, lists, code blocks, and other elements.
            </p>
...
{`<Note variant="filled" collapsible dismissible>
  Rich content with full formatting support
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <Note variant="outlined" title="WCAG 2.1 AA Compliance" icon="info">
          <ul className="list-inside list-disc space-y-2">
            <li><strong>Semantic Structure:</strong> Uses proper ARIA role=&quot;note&quot; with aria-live=&quot;polite&quot;</li>
            <li><strong>Keyboard Navigation:</strong> All interactive elements are fully keyboard accessible</li>
            <li><strong>Screen Reader Support:</strong> Icons are properly hidden, buttons have descriptive labels</li>
            ...
            <li><strong>Responsive Design:</strong> Adapts seamlessly across all device sizes</li>
            <li><strong>Dark Mode:</strong> Full theme support through DESIGN_TOKENS system</li>
            <li><strong>Performance:</strong> Optimized rendering with smooth animations</li>
          </ul>
        </Note>
      </section>
      ...
      <section className={DESIGN_TOKENS.spacing.sectionMargin}>
        ...
        <Note variant="filled" title="Enterprise-Grade Architecture" icon="bookmark">
          <ul className="list-inside list-disc space-y-1">
