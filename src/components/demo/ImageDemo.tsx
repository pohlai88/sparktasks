...
export default function ImageDemo() {
  ...
  return (
    <div className={`${DESIGN_TOKENS.spacing.section} max-w-7xl mx-auto`}>
      <div className="space-y-12">
        {/* Header */}
        <header className="text-center">
          <h1 className={`${DESIGN_TOKENS.typography.heading.h1} ${DESIGN_TOKENS.semantic.text.accent}`}>
            Image Component Demo
          </h1>
          <p className={`${DESIGN_TOKENS.typography.body.large} ${DESIGN_TOKENS.semantic.text.muted} mt-4`}>
            Enterprise-grade responsive image component with lazy loading, error handling, and accessibility.
          </p>
        </header>

        {/* Basic Usage */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Basic Usage</h2>
        ...
        {/* Aspect Ratios */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Aspect Ratios</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Square (1:1)</h3>
              <Image
                src={demoImages.square}
            ...
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Video (16:9)</h3>
              <Image
            ...
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Portrait (3:4)</h3>
              <Image
            ...
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Wide (21:9)</h3>
              <Image
                src={demoImages.wide}
        ...
        {/* Size Variants */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Size Variants (Auto Aspect)</h2>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 items-end">
            {(['xs', 'sm', 'md', 'lg', 'xl'] as const).map(size => (
              <div key={size} className="space-y-3">
                <h3 className={DESIGN_TOKENS.typography.heading.h4}>Size {size.toUpperCase()}</h3>
                <Image
                  src={demoImages.square}
        ...
        {/* Visual Variants */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Visual Variants</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Object Fit */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Object Fit Options</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {(['cover', 'contain', 'fill', 'scale-down', 'none'] as const).map(fit => (
              <div key={fit} className="space-y-3">
                <h3 className={DESIGN_TOKENS.typography.heading.h4}>
                  {fit.replace('-', ' ').replace(/\\b\\w/g, l => l.toUpperCase())}
                </h3>
                <Image
                  src={demoImages.landscape}
        ...
        {/* Loading States */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Loading States</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>With Skeleton</h3>
              <Image
                src={loadingSrc}
            ...
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Without Skeleton</h3>
              <Image
                src={loadingSrc}
            ...
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Custom Placeholder</h3>
              <Image
                src={loadingSrc}
                ...
                placeholder={
                  ...
                  `}>
                    <div className="text-center">
                      <div className="animate-spin size-8 border-2 border-current border-t-transparent rounded-full mx-auto mb-2" />
        ...
        {/* Error States */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Error Handling</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Default Fallback</h3>
              <Image
                src={errorSrc}
            ...
            <div className="space-y-3">
              <h3 className={DESIGN_TOKENS.typography.heading.h4}>Custom Fallback</h3>
              <Image
                src={errorSrc}
                ...
                fallback={
                  ...
                  `}>
                    <div className="text-center">
                      <svg className="size-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Disabled State */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Disabled State</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
        ...
        {/* Responsive Images */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Responsive Images</h2>
        ...
        {/* Accessibility */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Accessibility</h2>
          <div className="space-y-6">
            <div className={`${DESIGN_TOKENS.semantic.background.info} p-6 rounded-lg`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <h3 className={DESIGN_TOKENS.typography.heading.h4}>Descriptive Alt Text</h3>
                <Image
                  src={demoImages.landscape}
              ...
              <div className="space-y-3">
                <h3 className={DESIGN_TOKENS.typography.heading.h4}>High Contrast</h3>
                <Image
                  src={demoImages.portrait}
        ...
        {/* Performance */}
        <section>
          <h2 className={`${DESIGN_TOKENS.typography.heading.h2} mb-6`}>Performance Features</h2>
          <div className={`${DESIGN_TOKENS.semantic.background.success} p-6 rounded-lg`}>
            <h3 className="font-semibold mb-2">Built-in Optimizations:</h3>
            <ul className="space-y-1 text-sm">
