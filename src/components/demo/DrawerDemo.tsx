...
import Drawer, { Sheet, Sidebar, SlideOver, BottomSheet } from '@/components/ui/Drawer';
    ...
    <div className={`${DESIGN_TOKENS.layout.patterns.panelSection} space-y-8`}>
        ...
        <Card title="Compound Components" variant="raised">
          <div className="space-y-4">
            ...
            <div className={DESIGN_TOKENS.layout.grid.cols2}>
              ...
              <Button onClick={() => setSlideOverOpen(true)} variant="secondary">
                Detail SlideOver
              </Button>
              <Button onClick={() => setBottomSheetOpen(true)} variant="primary">
                Filter Bottom Sheet
              </Button>
            </div>
          </div>
      ...
      >
        <div className="space-y-4">
          <nav className="space-y-2">
            <a href="#" className={`${DESIGN_TOKENS.recipe.button.ghost} justify-start w-full`}>
              🏠 Dashboard
            </a>
            <a href="#" className={`${DESIGN_TOKENS.recipe.button.ghost} justify-start w-full`}>
              📊 Analytics
      ...
      <Drawer
        ...
        actions={[
          ...
          { label: 'Save Changes', onClick: () => setRightOpen(false), variant: 'primary' }
        ]}
      >
        <div className="space-y-6">
          <div className="space-y-4">
            <div>
              <label className={`${DESIGN_TOKENS.typography.body.primary} text-sm font-medium`}>
                Full Name
              </label>
              <input 
                type="text" 
          ...
          <div className={`${DESIGN_TOKENS.recipe.alert.success} border-0`}>
            <div className="flex">
              <div className="ml-3">
                ...
                <p className="text-sm opacity-90">Your data has been successfully backed up.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <Drawer
        ...
        actions={[
          ...
          { label: 'Delete', onClick: () => setDangerOpen(false), variant: 'destructive' }
        ]}
      >
        <div className="space-y-4">
      ...
      <Sheet
        ...
        actions={[
          { label: 'Reset to Default', onClick: () => {}, variant: 'secondary' },
          { label: 'Save Settings', onClick: () => setSheetOpen(false), variant: 'primary' }
        ]}
      >
        <div className="space-y-6">
          <div>
            <h4 className={`${DESIGN_TOKENS.typography.heading.h4} mb-3`}>Appearance</h4>
          ...
          <div>
            <h4 className={`${DESIGN_TOKENS.typography.heading.h4} mb-3`}>Notifications</h4>
            <div className="space-y-3">
              <label className="flex items-center">
      ...
      >
        <nav className="space-y-1">
          ...
          <a href="#" className="block px-3 py-2 rounded hover:bg-gray-100">About</a>
          <a href="#" className="block px-3 py-2 rounded hover:bg-gray-100">Services</a>
          <a href="#" className="block px-3 py-2 rounded hover:bg-gray-100">Portfolio</a>
          <a href="#" className="block px-3 py-2 rounded hover:bg-gray-100">Contact</a>
        </nav>
      </Sidebar>
      ...
      <BottomSheet
        ...
        actions={[
          ...
          { label: 'Apply Filters', onClick: () => setBottomSheetOpen(false), variant: 'primary' }
        ]}
      >
        <div className="space-y-6">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <button className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Active</button>
              <button className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-sm">Pending</button>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <button className="px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm">High</button>
              <button className="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">Medium</button>
              <button className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-sm">Low</button>
            </div>
          </div>
        </div>
      </BottomSheet>
