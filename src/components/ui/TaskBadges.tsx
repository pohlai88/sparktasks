...
export function PriorityBadge({ priority, className = '' }: PriorityBadgeProps) {
  const getIcon = (priority: 'P0' | 'P1' | 'P2') => {
    switch (priority) {
      case 'P0':
        return (
          <svg className={DESIGN_TOKENS.icons.badge} fill="currentColor" viewBox="0 0 20 20">
  ...
  const getIcon = (status: 'TODAY' | 'LATER' | 'DONE') => {
    switch (status) {
      ...
      case 'LATER':
        return (
          <svg className={DESIGN_TOKENS.icons.badge} fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.736 6.979C9.208 6.193 9.696 6 10 6s.792.193 1.264.979c.56 1.06.982 2.72.982 4.521s-.421 3.46-.982 4.521C10.792 17.807 10.304 18 10 18s-.792-.193-1.264-.979C8.176 15.96 7.754 14.3 7.754 12.5s.421-3.46.982-4.521z" clipRule="evenodd" />
          </svg>
        );
      case 'DONE':
        return (
