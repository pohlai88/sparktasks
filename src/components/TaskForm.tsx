...
export function TaskForm({ onSubmit, onCancel }: TaskFormProps) {
  ...
  return (
    <Card>
      <form onSubmit={handleSubmit} className={DESIGN_TOKENS.spacing.form} onKeyDown={handleKeyDown}>
        ...
        <div className="space-y-4">
          ...
          <div className={cn('grid grid-cols-1 sm:grid-cols-3', DESIGN_TOKENS.spacing.inline)}>
            <Input
              id="task-due"
              type="date"
              label="Due Date"
