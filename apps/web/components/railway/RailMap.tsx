...
export function RailMap({ projectId }: RailMapProps) {
  ...
  const stations: RailwayStation[] = [
    ...
    },
    {
      ...
      progress: 0.0,
      status: 'locked',
      academicAnchor: 'Kanban + Lean Manufacturing'
    },
    {
      id: 'handover',
      name: 'Handover',
  ...
  const getStatusVariant = (status: RailwayStation['status']) => {
    switch (status) {
  ...
  const getPMBOKVariant = (phase: RailwayStation['pmbokPhase']) => {
    switch (phase) {
              ...
              <div className="flex items-center gap-4 p-4 border rounded-lg">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <EnhancedBadge variant={getStatusVariant(station.status)}>
                      {station.status}
                    </EnhancedBadge>
