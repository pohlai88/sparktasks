...
import { EnhancedSeparator } from '@/enhanced/Separator'
  ...
  return (
    <EnhancedCards.Card>
      <EnhancedCards.Header>
        <EnhancedCards.Title>Project Scope Definition</EnhancedCards.Title>
      ...
      <EnhancedCards.Footer className="flex gap-2">
